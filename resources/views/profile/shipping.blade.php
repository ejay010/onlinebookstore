...
<div class="container-fluid breadcrumbBox text-center">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="/shipping">Review Shipping</a> </li>
    </ol>
</div>
...
{!! Form::open(['url' => '/shipping', 'name' => 'shippingInformation']) !!}
{!! Form::label('fullName', 'Full Name: ', ['class' => 'pull-left'] ) !!}
{!! Form::text('fullName', null, ['class' => 'form-control']) !!}
<br/>
{!! Form::label('address1', 'Address Line #1: ', ['class' => 'pull-left']) !!}
{!! Form::text('address1', null, ['class' => 'form-control']) !!}
<br/>
{!! Form::label('address2', 'Address Line #2: ', ['class' => 'pull-left']) !!}
{!! Form::text('address2', null, ['class' => 'form-control']) !!}
<br/>
{!! Form::label('city', 'City: ', ['class' => 'pull-left']) !!}
{!! Form::text('city', null, ['class' => 'form-control']) !!}
<br/>
{!! Form::label('state', 'State: ', ['class' => 'pull-left']) !!}
{!! Form::text('state', null, ['class' => 'form-control']) !!}
<br/>
{!! Form::label('zip', 'ZIP: ', ['class' => 'pull-left']) !!}
